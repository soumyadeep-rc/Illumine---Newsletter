...
function App() {
  ...
  useEffect(() => {
    console.log(
      "%c>> SUxMVU1JTkUgMjAyNiBJUyBDT01JTkc= <<",
  ...
  useEffect(() => {
    ...
    const elements = document.querySelectorAll('.neon-card, .neon-img');
  ...
  const goodwillMessagesList = [
    ...
    { name: "Pro Vice Chancellor", desc: "It is with great pride that I express my sincere appreciation for the organization of the biennial reunion of the Department of Information Technology, taking place this December 2026. This year marks a landmark milestone: the Silver Jubilee of a department that has served the academic and research fraternity with unwavering distinction for 25 years. This reunion, Illumine 2026, offers a vital opportunity to reconnect with the professors, colleagues, and friends who shaped your journey. The department’s impact now spans the globe—a testament to the visionary foundation laid by my esteemed colleague and long-time friend, Prof. Samiran Chattopadhyay, and the distinguished faculty members who championed its inception. Today, that legacy of excellence continues. The department remains one of the nation’s premier programs, and the NBA accreditation of the undergraduate curriculum stands as a global hallmark of the quality—an achievement bolstered by the consistent support of our alumni. While Jadavpur University navigates the unique challenges of a state-funded institution, our spirit remains indomitable. Our consistent standing in the National Institutional Ranking Framework (NIRF) reflects the brilliance of our scholars and the enduring strength of our community. We remain deeply grateful for the guidance from our alumni as we strive for new heights. I hope that the alumni of the department from across the globe will join us to celebrate this momentous occasion and wish all of you a truly joyous and memorable reunion." , img: "/faculty-provc.png" },
